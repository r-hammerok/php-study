...
if (!empty($_POST)) {
    ...
    if (isset($ret['success'])) {
        echo "Спасибо, ваш заказ будет доставлен по адресу: \"" . $ret['success']['address'] . "\"";
        echo "<br>";
        echo "Номер вашего заказа: #" . $ret['success']['lastOrder'];
        echo "<br>";
        echo "Это ваш {$ret['success']['countOrders']}-й заказ!";
    } else {
        foreach ($ret['error'] as $err) {
            echo "Ошибка: (" . $err['code'] . "). " . $err['message'] . "<br >";
        }
    }
    exit();
}
        ...
        <section class="section order">
          <div class="container">
            ...
            <div class="order__form">
              <form class="order__form-tag" id="order-form" action="index.php" method="post">
                <div class="order__form-col">
                  ...
                  <div class="order__form-row order__form-row_quatro">
                    ...
                    <label class="order__form-block">
                      ...
                      <input class="order__form-input" name="appt" type="text" placeholder="" required>
                    </label>
                    <label class="order__form-block">
                  ...
                  <div class="order__form-buttons">
                    <div class="order__form-row">
                      <label class="order__radio">
                        <input class="order__radio-elem" name="payment" type="radio" value="cach">
                        <div class="order__radio-fake"></div>
                        <div class="order__radio-title">Потребуется сдача</div>
                      </label>
                      <label class="order__radio">
                        <input class="order__radio-elem" name="payment" type="radio" value="card" checked>
                        <div class="order__radio-fake"></div>
